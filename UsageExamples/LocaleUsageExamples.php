...
try
{
  $locale = new Locale($locales, $locales_dir, $domain_default, $codeset, $lang_default, $cookieroot, $cookiedomain, $cookiesecure, $lc_category, $useGettext, $useCustomPluralForms, $usePluralFormsFromGettext, $debug, $project);
